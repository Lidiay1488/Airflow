...
dag = DAG('2_1_task1', description='Hello World DAG!',
...
hello_file_operator = BashOperator(task_id='/opt/airflow/scripts/hello_file_task', bash_command='file1.sh', dag=dag)
